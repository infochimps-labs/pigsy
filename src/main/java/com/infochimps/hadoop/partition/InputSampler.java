package com.infochimps.hadoop.partition;
...
// FIXME!!!!!!!!!!!!!!!!!!!! standby class until we upgrade to hadoop 0.21
...
public class InputSampler<K,V> extends Configured implements Tool  {
  ...
  // FIXME: Not writing partition file quite right
  ...
  public static <K,V> void writePartitionFile(Job job, Sampler<K,V> sampler) 
    ...
    for (K smpl : samples) {
        LOG.info("sample class is ["+smpl.getClass().getName()+"] with value ["+smpl+"]");
    }
    ...
    writer.close();
    LOG.info("Wrote partitions successfully");
  }

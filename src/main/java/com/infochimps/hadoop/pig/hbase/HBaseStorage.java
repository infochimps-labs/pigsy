...
/**
 * FIXME! Broken broken broken since latest upgrade of hbase. Incorporate changes
 * from pig trunk.
 */
...
// LATEST PIG TRUNK VERSION (why the FUCK would you ever want to read data into a pig map?! Oh that's right, you wouldn't)
